...
namespace Blog.Service.Helpers.Images
{
    public class ImageHelper : IImageHelper
    {
        ...
        private const string articleImagesFolder = "article-images";  //Bunlar sadece klosör isimlerimiz
        private const string userImagesFolder = "user-images";     



        public ImageHelper(IWebHostEnvironment env)//Rote dosyamı bu file sayesinde oluşturuyorum(web in altındaki root da olacak dosyalarım)
        {
            this._webHostEnvironment = env;
            wwwroot = env.WebRootPath; //wwwroot çağırdgımda program benim rootu çağırdığımı bilmiş oluyor
        }
